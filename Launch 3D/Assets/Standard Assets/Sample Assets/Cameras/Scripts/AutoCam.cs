...
public class AutoCam : PivotBasedCameraRig
{
	...
	[SerializeField] private bool FOVfollowVelocity = true;         // Whether the camera FOV should widen with speed
...
//	void FixedUpdate()
//	{
//		if (FOVfollowVelocity && Application.isPlaying)
//		{
//			float acceleration = (rigidbody.velocity - previousVelocity).magnitude;
//			
//			
//			previousVelocity = rigidbody.velocity;
//			
//			//print (defaultFOV + acceleration * zoomFactor);
